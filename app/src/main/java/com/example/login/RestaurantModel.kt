...
data class RestaurentModel(val name: String?, val alamat: String?, val delivery_charge: String?,
...
data class Menus(val name: String?, val harga: Float,  val url: String?, var totalInCart: Int) :
    Parcelable {
    constructor(parcel: Parcel) : this(
        parcel.readString(),
        parcel.readFloat(),
